  ...
  return (
    <div className="px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between gap-12">
      <div className="md:w-1/2">
        <img src={FavoriteBookImg} className="rounded md:w-10/12" alt="" />
      </div>
      <div className="md:w-1/2 space-y-6">
        <h2 className="text-5xl font-bold my-5 md:w-3/4 leading-snug">
          Find Your Favorite <span className="text-blue-700">Books Here!</span>
        </h2>
        <p className="mb-10 text-lg md:w-5/6">Lorem ipsum dolor sit amet consectetur adipisicing elit. Atque tenetur consectetur similique id nihil numquam eveniet suscipit maiores, quisquam quae in. Ratione pariatur recusandae cupiditate suscipit harum vero illo repudiandae.</p>
